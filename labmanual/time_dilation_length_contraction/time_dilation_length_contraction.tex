...
\item If Anna measures the round trip time to be 6 nanoseconds, what does Bob measure?
\answerspace{0.5in}
...
\begin{enumerate}[wide]
\item What does Anna say her speed $v$ is?  (Same as what Bob measures, bigger, or smaller?)
\answerspace{0.5in}

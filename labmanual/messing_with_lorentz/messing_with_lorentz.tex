...
Open the Mathematica notebook \filename{minkowski\_events.nb}.  Hit \button{Control-A} to select all text, and
...
%To change the points, you will need to edit the two lines in the Mathematica file that say
